 ...
 * @since       2.5
 */
class RealtorControllerLead extends JControllerForm
{
	/**
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_realtor&view=leads' . $this->getRedirectToListAppend(), false));
