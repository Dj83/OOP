...
<article class="item" data-permalink="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catid), true, -1); ?>">
		...
		<p class="meta">
			...
			<?php
				...
				if ($params->get('show_create_date')) {
					echo ' '.JText::_('TPL_METRO_ON').' <time datetime="'.substr($this->item->created, 0,10).'" pubdate>'.JHtml::_('date', $this->item->created, JText::_('DATE_FORMAT_LC3')).'</time>';
				}
				...
				if ($params->get('show_category')) {
					echo JText::_('TPL_METRO_POSTED_IN').' ';
		...
		<a href="<?php echo $link; ?>" title="<?php echo $this->escape($this->item->title); ?>">
			<?php
				...
				if (!$params->get('access-view')) {
					...
					echo JText::_('TPL_METRO_CONTINUE_READING');
				}
	...
	<?php if ($canEdit) : ?>
	<p class="edit"><?php echo JHtml::_('icon.edit', $this->item, $params); ?> <?php echo JText::_('TPL_METRO_EDIT_ARTICLE'); ?></p>
	<?php endif; ?>
